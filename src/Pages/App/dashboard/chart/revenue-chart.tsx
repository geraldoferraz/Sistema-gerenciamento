            ...
            <CardContent>
                <ResponsiveContainer width="100%" height={240}>
                    <LineChart data={data} style={{ fontSize: 12 }}>
                        ...
                        {/* aqui nos adicionamos as linhas no meio do gráfico */}
                        <CartesianGrid vertical={false} className="stroke-muted"/>

                        {/* strokeWidth = grossura da linha && dataKey="revenue aqui estamos definindo qual dado o grafico vai levar em consideracao para ele subir ou descer"*/}
                        <Line type="linear" strokeWidth={2} dataKey="revenue" stroke="#7C3AED"/> 
